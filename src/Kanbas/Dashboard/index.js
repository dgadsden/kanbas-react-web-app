  ...
  return (
    <div id="dash-container">
      ...
      <div className="d-flex flex-wrap">
        {courses.map((course) => (
          <Link key={course._id} to={`/Kanbas/courses/${course._id.$oid}`} className="link-class">
            <div className="card" style={{ width: '18rem' }}>
              ...
              <div className="card-body">
                ...
                <a href={`/Kanbas/Courses/${course._id.$oid}`} > <FaFileAlt style={{ fontSize: 25, color: "gray" }} /></a>
              </div>
            </div>
          </Link>
        ))}
